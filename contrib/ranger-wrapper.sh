...
if [ "$save" = "1" ]; then
    set -- --choosefiles="$out" --cmd="echo Select save path (see tutorial in preview pane; try pressing zv or zp if no preview)" --selectfile="$path"
